		...
		*/
		'menu' => [
			[	'icon' => 'fa fa-home',
				...
				'caret' => true,
				'sub_menu' => [[
					'url' => '/catalogos/brokers',
					'title' => 'Brokers'
				],[
					'url' => '/catalogos/cc_companias',
					'title' => 'CC por compa&ntilde;&iacute;as'
				],[
					'url' => '/catalogos/companias',
					'title' => 'Compa&ntilde;&iacute;as'
				],[
					'url' => '/catalogos/dispositivos',
					'title' => 'Dispositivos'
				],[
					'url' => '/catalogos/ejecutivos',
					'title' => 'Ejecutivos de reclamos'
				],[
					'url' => '/catalogos/inspectores',
					'title' => 'Inspectores'
				],[
					'url' => '/catalogos/supervisores',
					'title' => 'Supervisores legales'
				],[
					'url' => '/catalogos/talleres',
					'title' => 'Talleres'
				],[
					'url' => '/catalogos/todos',
					'title' => 'Todos'
				...
				'sub_menu' => [[
					'url' => '/dashboard/v1',
					'title' => 'Im&aacute;genes de inspecciones'
				],[
					'url' => '/dashboard/v2',
					'title' => 'Inspecciones de Siniestro'
				]]
			],[
				'icon' => 'fa fa-file-alt',
				'title' => 'Reporter&iacute;a',
				'url' => 'javascript:;',
				'caret' => true,
				'sub_menu' => [[
					'url' => '/dashboard/v1',
