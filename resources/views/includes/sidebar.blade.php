...
<div id="sidebar" class="sidebar {{ $sidebarClass }}">
	...
	<div data-scrollbar="true" data-height="100%">
		...
		<ul class="nav">
			<li class="nav-profile">
				@if(Auth::user() )
					@if(Auth::user()->name == 'Administrador' ) 
						<a href="javascript:;" data-toggle="nav-profile">
							...
							<div class="info">
								...
								{{ Auth::user()->name }}
								<small>@lang("menu.gsi_user")</small>
							</div>
						</a>
					@else
						<div class="cover with-shadow"></div>
					...
					@endif
				@else
					<small>@lang("menu.guest")</small>
				@endif
			</li>
			<li>
				<ul class="nav nav-profile">
					<li><a href="/config/usuarios"><i class="fa fa-cog"></i> @lang("menu.settings")</a></li>
				</ul>
			</li>
		</ul>
		<!-- end sidebar user -->
		<!-- begin sidebar nav -->
		<ul class="nav">
			<li class="nav-header">@lang("menu.navigation")</li>
			@php
