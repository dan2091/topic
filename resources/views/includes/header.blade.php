...
<div id="header" class="header {{ $headerClass }}">
	...
	<div class="navbar-header">
		<a href="/login" class="navbar-brand"><i class="text-primary fa fa-check-square"></i> <b>G.S.I.</b> Web</a>
		@if (!$sidebarHide)
	...
	<ul class="navbar-nav navbar-right">
		...
		@php $v_lang = ( App::getLocale() == 'en' ? 'us' : 'es' ); @endphp
		<input type='hidden' value='<?=$v_lang;?>' id="hd_app_language"/>
		<li class="dropdown navbar-language">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
				<span class="flag-icon flag-icon-<?= $v_lang;?>" title="<?= $v_lang;?>"></span>
				<span class="name"><?= strtoupper($v_lang);?></span> <b class="caret"></b>
			</a>
			<ul class="dropdown-menu p-b-0">
				<li class="arrow"></li>
				<li><a href="/setlocale/en"><span class="flag-icon flag-icon-us" title="us"></span> English</a></li>
				<li><a href="/setlocale/es"><span class="flag-icon flag-icon-es" title="es"></span> Espa&ntilde;ol</a></li>
		...
		@if(Auth::user() ) 
			<li class="dropdown navbar-user">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<a href="javascript:;" class="dropdown-item"><i class="fa fa-user-circle"></i> @lang("menu.profile")</a>
